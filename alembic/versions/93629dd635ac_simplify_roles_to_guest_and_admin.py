"""simplify roles to guest and admin

Revision ID: 93629dd635ac
Revises: 
Create Date: 2026-08-04 18:11:49.174804
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('ADMIN', 'GUEST', name='role'), nullable=False),
